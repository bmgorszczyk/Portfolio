			...
			<div className="col-md-5 col-sm-12">
				<ReactCSSTransitionGroup
					...
					<article className="work-text">
						<h4 className="work-title">Elegance</h4>
						<p className="work-desc">{T.translate("works.5thdesc")}</p>
						...
						<ul className="techList">
							...
							<li><span className="fa fa fa-circle"></span>jQuery</li>
						</ul>
			...
			<div className="col-md-7 col-sm-12">
				<ReactCSSTransitionGroup
					...
					<article className="work-img">
						<img src={elegant} alt="elegantScreenShot"/>
					</article>
				</ReactCSSTransitionGroup>
			</div>
		</section>
